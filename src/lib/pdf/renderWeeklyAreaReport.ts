...
export function renderWeeklyAreaReport(): string {
    return `
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <p>Este es un PDF de prueba generado en Vercel.</p>
    <p>Si puedes descargar este archivo, Chromium está funcionando.</p>
