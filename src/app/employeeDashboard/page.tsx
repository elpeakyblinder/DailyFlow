      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <header className="flex items-center justify-between pb-4 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-semibold">Juan Pérez</h1>
        ...
        <section className="bg-card border border-border p-6 rounded-xl shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-all hover:border-primary/50">
          ...
          <button className="group flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-primary/90 transition-all w-full sm:w-auto justify-center shadow-[0_0_15px_-3px_var(--color-primary)]">
