...
<body>
    ...
    <p>Si puedes descargar este archivo, Chromium funciona en Vercel.</p>
    <p>Fecha:</p>
...
export async function GET() {
    ...
    try {
        ...
        await page.setContent(renderTestPdf(), {
            waitUntil: "load",
        });
        ...
        console.error(error);
        return NextResponse.json(
            { error: `Error al generar PDF de prueba: ${error}` },
            { status: 500 }
        );
    } finally {
        await browser.close();
